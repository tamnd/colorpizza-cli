...
Most of these come down to network reality or how color serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

color rate-limits like any public site. color already paces
...
Where a surface is gated, color reads a cookie or token you supply
...
`color`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what color actually did
